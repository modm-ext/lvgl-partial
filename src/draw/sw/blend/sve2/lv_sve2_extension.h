...
#define lv_sve_stride_loop_pixel(ma_stride_size, ma_pred_name)            \
...
#define lv_sve_pixel_ccca_foreach_chn012( ma_source_u16x4,                \
                                          ma_target_u16x4,                \
                                          ...)                            \
    do {                                                                  \
...
#define lv_sve_pixel_ccca_foreach_chn( ma_source_u16x4,                   \
                                       ma_target_u16x4,                   \
                                       ...)                               \
    do {                                                                  \
        svuint16x4_t sve_source_u16x4 = ma_source_u16x4;                  \
...
#define lv_sve_pixel_u16x4_foreach_chn012_to_ccc(   ma_source_u16x4,      \
                                                    ma_target_u16x3,      \
                                                    ...)                  \
    do {                                                                  \
        svuint16x4_t sve_source_u16x4 = ma_source_u16x4;                  \
...
#define lv_sve_pixel_u16x3_foreach_chn_to_cccn( ma_source_u16x3,          \
                                                ma_target_u16x4,          \
                                                ...)                      \
    do {                                                                  \
        do {                                                              \
...
/*! \note the Element range of vSourceMask is [0, 0xFF]
 */
...
/*! \note the Element range of vOpacity is [0, 0x100]
 */
static inline svuint16_t lv_sve_chn_blend_with_vopacity_fast(svuint16_t vSource,
                                                             svuint16_t vTarget,
                                                             svuint16_t vOpacity)
{
    // vTarget = vSource * vMask + vTarget * (255 - vMask);
    svuint16_t vTemp0 = svmul_u16_m(svptrue_b16(), vSource, vOpacity);
    vTemp0 = svmla_u16_m(svptrue_b16(),
                         vTemp0,
                         vTarget,
                         svsub_u16_m(svptrue_b16(),
                                                                 ...
                                                                 uint16_t hwOpacity)
{
    ...
    return lv_sve_chn_blend_with_vopacity_fast(vSource, vTarget, vMask);
}

/*! \note the Element range of vMask is [0, 0xFF]
 *  \note the hwOpacity range [0, 0x100]
 */
static inline svuint16_t lv_sve_chn_premultiplied_blend_with_mask_and_opacity(
                                                                 svuint16_t vSource,
                                                                 svuint16_t vTarget,
 ...
 */
static inline svuint16_t lv_sve_chn_premultiplied_blend_with_masks(svuint16_t vSource,
                                                      svuint16_t vTarget,
                                                      svuint16_t vReciprocal,
                                                      svuint16_t vMask0,
                                                      svuint16_t vMask1)
 ...
 *  \note the hwOpacity range [0, 0x100]
 */
static inline svuint16_t lv_sve_chn_premultiplied_blend_with_masks_and_opacity(
    svuint16_t vSource,
    svuint16_t vTarget,
    svuint16_t vReciprocal,
    svuint16_t vMask0,
    ...
    uint16_t hwOpacity)
{
    ...
    vMask =
        svsel(svcmpge_n_u16(svptrue_b16(), vMask, 255),
              svdup_u16(hwOpacity),
              //(vMask * hwOpacity) >> 8,
              svlsr_n_u16_x(svptrue_b16(),
                            svmul_n_u16_x(svptrue_b16(), vMask, hwOpacity),
                            8));
